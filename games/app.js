...
function renderGames(){
  ...
  $('#games').innerHTML = visible.map((game)=>{
    ...
    return `<article class="game-card">
      <a class="game-image" href="${game.path}" aria-label="${escapeHtml(t.play)} — ${escapeHtml(game.title)}"><img src="${game.image}" alt="Last Stand — поле боя Tower Defense" loading="eager"></a>
      <div class="game-content">
        ...
        <a class="play" href="${game.path}">${escapeHtml(t.play)} <span aria-hidden="true">→</span></a>
        <details class="attribution">
          ...
          <dl>
            ...
            <div><dt>${escapeHtml(t.license)}</dt><dd><a href="${game.path}LICENSE" target="_blank">${escapeHtml(game.license)} ↗</a></dd></div>
