...
sw.includes('portable-tests-v1.7.1') || fail('PWA cache not bumped');
...
console.log('OK: result links, shared cards, private app sharing, eight catalog entries, and PWA v1.7.1');
