const CACHE='portable-tests-v1.9.7';
const ASSETS=[
  './','./index.html','./styles.css','./app.js','./site-ui.js','./loader-overlay.js','./tests-registry.json','./hub-locales.json','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./og-cover.webp','./robots.txt','./sitemap.xml','./hero-career.webp','./hero-team.webp','./hero-decisions.webp','./hero-environment.webp','./assets/fly-meme.webp','./assets/fly-sprite.png','./assets/fly-sprite-walk2.png','./assets/fly-sprite-groom.png','./modules/dice-fate.html','./modules/dice-variants.js','./modules/fly-game.html','./modules/fly-game.js','./modules/fly-engine.js','./games/','./games/index.html','./games/styles.css','./games/app.js','./games/game-page.js','./games/games-registry.json','./games/last-stand/','./games/last-stand/index.html','./games/tower-defense/last-stand/docs/hero.png','./games/flatland-td/','./games/flatland-td/index.html','./games/tower-defense/flatland-td/branding/flatland-logo-large.png',
