const CACHE='porthub-v1.14.0';
const ASSETS=[
  './','./index.html','./styles.css','./brand.css','./app.js','./site-ui.js','./loader-overlay.js','./tests-registry.json','./hub-locales.json','./manifest.webmanifest','./icon-porthub-192.png','./icon-porthub-512.png','./og-cover.webp','./robots.txt','./sitemap.xml','./privacy/','./privacy/index.html','./privacy/styles.css','./privacy/app.js','./hero-career.webp','./hero-team.webp','./hero-decisions.webp','./hero-environment.webp','./assets/fly-meme.webp','./assets/fly-sprite.png','./assets/fly-sprite-walk2.png','./assets/fly-sprite-groom.png','./modules/dice-fate.html','./modules/dice-variants.js','./modules/fly-game.html','./modules/fly-game.js','./modules/fly-engine.js','./games/','./games/index.html','./games/styles.css','./games/app.js','./games/game-page.js','./games/games-registry.json','./games/last-stand/','./games/last-stand/index.html','./games/tower-defense/last-stand/docs/hero.png','./games/flatland-td/','./games/flatland-td/index.html','./games/tower-defense/flatland-td/branding/flatland-logo-large.png',
  './tests/career/index.html','./tests/career/styles.css','./tests/career/app.js','./tests/career/data.js',
  './tests/anti-iq/','./tests/anti-iq/index.html','./tests/anti-iq/styles.css','./tests/anti-iq/app.js',
  './comics/','./comics/index.html','./comics/styles.css','./comics/bubbles.css','./comics/app.js','./comics/night-noir/frame-01.webp','./comics/night-noir/frame-02.webp','./comics/night-noir/frame-03.webp','./comics/night-noir/frame-04.webp','./comics/night-noir/frame-05.webp','./comics/night-noir/frame-06.webp','./comics/eclipse-protocol/frame-01.webp','./comics/eclipse-protocol/frame-02.webp','./comics/eclipse-protocol/frame-03.webp','./comics/eclipse-protocol/frame-04.webp','./comics/eclipse-protocol/frame-05.webp','./comics/eclipse-protocol/frame-06.webp',
  ...
  './compatibility/index.html','./compatibility/styles.css','./compatibility/app.bundle.js','./compatibility/locales/ru.json','./compatibility/locales/kk.json','./compatibility/locales/en.json','./compatibility/locales/fr.json',
...
self.addEventListener('install',event=>event.waitUntil(caches.open(CACHE).then(cache=>Promise.allSettled(ASSETS.map(asset=>cache.add(asset))))));
